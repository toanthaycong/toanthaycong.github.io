...
!function (t, e) {
    ...
    _createClass(Z, [{
      ...
      value: function _setActiveIndicatorElement(t) {
        if (this._indicatorsElement) {
          ...
          for (var _e7 = 0; _e7 < _i3.length; _e7++) if (Number.parseInt(_i3[_e7].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(t)) {
  ...
  P.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Z.dataApiClickHandler), P.on(window, "load.bs.carousel.data-api", function () {
    ...
    for (var _e8 = 0, _i4 = t.length; _e8 < _i4; _e8++) Z.carouselInterface(t[_e8], Z.getInstance(t[_e8]));
  }), m(Z);
  var J = {
      toggle: !0,
      parent: null
  ...
  var Re = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
    ...
    qe = function qe(t, e) {
      ...
      for (var _t10 = 0, _e11 = n.length; _t10 < _e11; _t10++) if (n[_t10].test(i)) return !0;
      return !1;
    };
  function Fe(t, e, i) {
    var _ref7;
  ...
  var Ye = /*#__PURE__*/function (_H8) {
    ...
    _createClass(Ye, [{
      ...
      value: function _getDelegateConfig() {
        var t = {};
        for (var _e14 in this._config) this.constructor.Default[_e14] !== this._config[_e14] && (t[_e14] = this._config[_e14]);
        return t;
      }
    }, {
      key: "_cleanTipClass",
    ...
    _createClass(ni, [{
      ...
      value: function _process() {
        ...
        if (this._scrollHeight !== e && this.refresh(), t >= i) {
          ...
          for (var _e15 = this._offsets.length; _e15--;) this._activeTarget !== this._targets[_e15] && t >= this._offsets[_e15] && (void 0 === this._offsets[_e15 + 1] || t < this._offsets[_e15 + 1]) && this._activate(this._targets[_e15]);
        }
      }
    }, {
      key: "_activate",
